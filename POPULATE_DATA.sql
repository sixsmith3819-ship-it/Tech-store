-- ============================================================================
-- ORACLE TECH STORE - SAMPLE DATA POPULATION
-- ============================================================================
-- This script populates the database with realistic sample data
-- Use this to test all features without manual data entry
--
-- NOTE: Run this AFTER running FIX_RLS_RECURSION.sql
-- ============================================================================
...
-- ============================================================================
-- 2. POPULATE PRODUCTS (60+ products)
-- ============================================================================
...
-- ============================================================================
-- 3. SKIP USER PROFILES FOR NOW
-- ============================================================================
-- NOTE: Users must be created through signup first (creates auth.users)
-- Then they automatically get a profile from the trigger
--
-- To test with users:
-- 1. Sign up manually at /auth/signup
-- 2. Create test accounts
-- 3. They'll automatically get profiles
--
-- For now, we'll skip user profiles and focus on products and other data

-- ============================================================================
-- 4. CREATE SAMPLE ORDERS (using service role for demo)
-- ============================================================================
-- NOTE: These orders need valid user IDs from auth.users table
-- For now, we'll create sample orders but they'll need real user IDs
-- 
-- To populate orders after creating users:
-- 1. Sign up test accounts
-- 2. Get their auth.users IDs
-- 3. Update the orders with real user IDs

-- ============================================================================
-- 5. CREATE SAMPLE SERVICE REQUESTS
-- ============================================================================
-- NOTE: These need valid user IDs - will be added after user signup

-- Placeholder: Service requests can be added after users are created
...
-- Placeholder: Messages can be added after users are created
...
SELECT 
  ...
  (SELECT COUNT(*) FROM profiles) as total_user_profiles,
...
-- ✅ 60+ Products with prices and stock levels
-- ✅ Products ready for browsing (NO AUTH NEEDED)
--
-- For orders, services, and messages:
-- 1. First, sign up test accounts at /auth/signup
-- 2. Get the auth.users IDs from Supabase
-- 3. Run POPULATE_DATA_WITH_USERS.sql (coming next)
--
-- You can now:
-- 1. Browse 60+ products at /products
-- 2. Sign up new accounts
-- 3. Create orders with real user accounts
-- 4. Request services
-- 5. Send messages
--
-- ============================================================================
